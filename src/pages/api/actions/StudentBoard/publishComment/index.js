...
const { 
    goError, 
    goRandom,
    goStudentBoardByDefault
} = require("./channels");
const getComments = require("../../common/getComments");
const insertComment = require("../../common/insertComment");
...
module.exports = createActionController(async input => {
    const { comment, username } = input;

    await insertComment({ username, comment });

    return goStudentBoardByDefault({
        username,
